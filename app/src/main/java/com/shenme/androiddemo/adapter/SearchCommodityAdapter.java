...
public class SearchCommodityAdapter extends CommonAdapter<SearchProductActivity.TwoProducts> {
    ...
    public void convert(final ViewHolder holder, SearchProductActivity.TwoProducts product) {
        ...
        SimpleDraweeView iv4 = holder.getView(R.id.iv_goods4);
        ...
        iv4.setImageURI(product.list.get(0).thumbnail);
        ...
        btn_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                int position = ((type == SearchProductActivity.VIEW_STYLE_LIST) ? holder.position : holder.position * 2);
                listener.addToCart(position, (Activity) context, shoppingcart, (ImageView) holder.getView(R.id.iv_goods4));
            }
        });
        if (type == SearchProductActivity.VIEW_STYLE_GRID) {
            ...
            if (product.list.size() == 2) {
                ...
                SimpleDraweeView iv5 = holder.getView(R.id.iv_goods5);
...
//                }
                ...
                if (type == SearchProductActivity.VIEW_STYLE_GRID) {
                    ...
                    iv4.getLayoutParams().width = (screendWidth / 2) - 1;
                    iv4.getLayoutParams().height = (screendWidth / 2) - 1;
                    iv5.getLayoutParams().width = (screendWidth / 2) - 1;
                    iv5.getLayoutParams().height = (screendWidth / 2) - 1;

                }

                iv1.setImageURI(product.list.get(1).thumbnail);
                iv5.setImageURI(product.list.get(1).thumbnail);
                ...
                btn_add1.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        listener.addToCart((holder.position * 2 + 1), (Activity) context, shoppingcart, (ImageView) holder.getView(R.id.iv_goods5));
                    }
                });
