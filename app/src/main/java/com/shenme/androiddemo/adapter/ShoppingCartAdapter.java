...
public class ShoppingCartAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        ((ShoppingCartViewHolder) viewHolder).commodityCurrentCrice.setText(Utils.PriceFormat(datas.get(i).getActPrice()));
        ...
        ((ShoppingCartViewHolder) viewHolder).commoditOriginalPrice.setText(Utils.PriceFormat(datas.get(i).getBasePrice()));
        ((ShoppingCartViewHolder) viewHolder).totalPrice.setText(Utils.PriceFormat(datas.get(i).getTotalPrice()));
