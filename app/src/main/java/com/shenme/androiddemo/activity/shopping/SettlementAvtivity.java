...
import com.shenme.androiddemo.data.shoppingcart.PaymentMode;
import com.shenme.androiddemo.data.shoppingcart.ResponseOrderCreate;
import com.shenme.androiddemo.data.shoppingcart.ResponseShoppingCart;
        ...
        RetrofitUtil.getHttpService().createOrder(
                ...
                .subscribe(new CodeHandledSubscriber<ResponseOrderCreate>() {
                    ...
                    protected void onBusinessNext(ResponseOrderCreate data) {
                        ...
                        String resultData = gson.toJson(data.resultData);
                        intent.putExtra(ResultActivity.RESULT_DATA, resultData);
